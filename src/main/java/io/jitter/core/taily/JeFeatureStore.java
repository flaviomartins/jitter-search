...
public class JeFeatureStore implements FeatureStore {
    private static final Logger logger = LoggerFactory.getLogger(JeFeatureStore.class);
    ...
    public JeFeatureStore(String dir, boolean readOnly) {
